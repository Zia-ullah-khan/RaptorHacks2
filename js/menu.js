...
// configuration
const CONFIG = {
  colors: { bg: "#0a0a0a", fg: "#00ff41" },
};

const MENU_ITEMS = [
  { label: "Home", icon: "home-sharp", href: "/" },
  { label: "Event Info", icon: "information-circle-sharp", href: "/lab" },
  { label: "Tracks", icon: "trophy-sharp", href: "/work" },
  { label: "Schedule", icon: "calendar-sharp", href: "/project" },
  { label: "Register", icon: "person-add-sharp", href: "/contact" },
];
